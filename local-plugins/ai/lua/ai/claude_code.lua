...
local function get_template_path()
  return Paths.legacy_template("claude_code")
end

local function get_ccstatusline_template_path()
  return Paths.ccstatusline_template()
end
...
function M.get_status()
  ...
  -- 获取 ECC 状态
  local ecc_status = nil
  local ok_ecc, Ecc = pcall(require, "ai.ecc")
  if ok_ecc and Ecc.get_status then
    ecc_status = Ecc.get_status()
  end
