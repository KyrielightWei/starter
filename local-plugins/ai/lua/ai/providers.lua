...
M.register("bailian_coding", {
  ...
  model_info = {
    ...
    ["qwen3.7-plus"] = {
      limit = { context = 1000000, output = 65536 }, -- 1M context
      description = "最新多模态模型 - 阿里Qwen3.7-Plus，Agent/工具调用/视觉",
    },
    ["qwen3-coder-plus"] = {
      limit = { context = 1000000, output = 65536 }, -- 1M context
      description = "代码专家 - Qwen3-Coder-Plus，复杂项目和深度代码审查",
    },
    ["qwen3-coder-next"] = {
      limit = { context = 262144, output = 65536 }, -- 256k context
      description = "代码实验 - Qwen3-Coder-Next，最新代码模型",
    },
    ["qwen3-max-2026-01-23"] = {
      limit = { context = 262144, output = 65536 }, -- 256k context
      description = "旗舰快照 - Qwen3-Max 固定版本",
    },
    ["glm-4.7"] = {
      limit = { context = 202752, output = 16384 }, -- 200k context
      description = "智谱GLM-4.7，上一代旗舰",
    },
    ["kimi-k2.5"] = {
