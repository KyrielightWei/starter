...
--- 组件可选缓存方法列表（per D-11）
M.optional_cache_methods = {
  { name = "is_cached", type = "function" },
  { name = "get_cache_version", type = "function" },
  { name = "get_deploy_paths", type = "function" },
  { name = "pre_deploy", type = "function" },
  { name = "post_deploy", type = "function" },
}
...
--- Optional cache methods (per D-11)
---@field is_cached function(): boolean|nil
---@field get_cache_version function(): string|nil
---@field get_deploy_paths function(target: string): table[]|nil
---@field pre_deploy function(target: string): boolean, string|nil
---@field post_deploy function(target: string): boolean, string|nil
...
function M.get_interface_summary()
  ...
  table.insert(lines, "")
  table.insert(lines, "Optional Cache Methods:")
